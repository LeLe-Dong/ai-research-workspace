...
REVIEWER_SYSTEM = """You are a strict technical reviewer.

CRITICAL: Reply with ONLY a JSON object. No preamble, no explanation, no markdown fences.
...
Required JSON shape:
{
  ...
  "overall_score": <mean of 6>,
  "strengths": "<one paragraph>",
  "weaknesses": "<one paragraph>",
  "suggestions": "<one paragraph>"
}
...
REVIEWER_USER_TEMPLATE = """Research Report:
{report}
